...
const CourseSidebarStudent = (props) => {
  ...
  return (
    <div className='sticky top-0 left-0 h-screen flex flex-col items-center bg-tertiary'>
      ...
      <NavLink to={'home'} className={({ isActive }) => ((isActive ? 'bg-accent text-secondary' : 'text-accent bg-transparent border border-solid border-accent_dark hover:bg-secondary hover:bg-opacity-[0.02] hover:border-accent') + 'mx-8 my-2 p-1.5 w-40 flex flex-row justify-center items-center rounded-md')}>
        <p className='text-center text-inherit'>HOME</p>
      </NavLink>
      ...
      <NavLink to={'grades'} className={({ isActive }) => ((isActive ? 'bg-accent text-secondary' : 'text-accent bg-transparent border border-solid border-accent_dark hover:bg-secondary hover:bg-opacity-[0.02] hover:border-accent') + 'mx-8 my-2 p-1.5 w-40 flex flex-row justify-center items-center rounded-md')}>
        <p className='text-center text-inherit'>GRADES</p>
      </NavLink>
      <div className='flex flex-col mb-16 mt-auto items-center'>
        <NavLink to={'/student/dashboard/courses'} className={({ isActive }) => ((isActive ? 'bg-accent text-secondary' : 'text-accent bg-transparent border border-solid border-accent_dark hover:bg-secondary hover:bg-opacity-[0.02] hover:border-accent') + 'mx-8 my-2 p-1.5 w-40 flex flex-row justify-center items-center rounded-md')}>
          <ArrowBackIcon className='mx-2' fontSize='small' /><p className='text-center text-inherit'>COURSES</p>
        </NavLink>
...
export default CourseSidebarStudent